...
- **Tutor Group**: A family belongs to a Tutor Group (many-to-one, required)
...
1. **Tutor Group Required**: Every family must belong to a tutor group
...
6. **Single Tutor Group**: A family can only belong to one tutor group at a time
...
- When a family changes tutor groups, all associated students and data move with it
